...
public class Bones {
	...
	public static void leave() {
		...
		//heroes which have won the game, who die far above their farthest depth, or in town, or who are challenged drop no bones.
		if (Statistics.amuletObtained || (Statistics.deepestFloor - 5) >= depth || Dungeon.challenges > 0 || depth == 0) {
			depth = -1;
			return;
		}
