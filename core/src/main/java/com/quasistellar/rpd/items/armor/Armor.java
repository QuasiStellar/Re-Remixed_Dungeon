...
import com.quasistellar.rpd.items.EquipableItem;
import com.quasistellar.rpd.items.Item;
import com.quasistellar.rpd.items.armor.curses.AntiEntropy;
import com.quasistellar.rpd.items.armor.curses.Bulk;
import com.quasistellar.rpd.items.armor.curses.Corrosion;
import com.quasistellar.rpd.items.armor.curses.Displacement;
import com.quasistellar.rpd.items.armor.curses.Metabolism;
import com.quasistellar.rpd.items.armor.curses.Multiplicity;
import com.quasistellar.rpd.items.armor.curses.Overgrowth;
import com.quasistellar.rpd.items.armor.curses.Stench;
import com.quasistellar.rpd.items.armor.glyphs.Affection;
import com.quasistellar.rpd.items.armor.glyphs.AntiMagic;
import com.quasistellar.rpd.items.armor.glyphs.Brimstone;
import com.quasistellar.rpd.items.armor.glyphs.Camouflage;
import com.quasistellar.rpd.items.armor.glyphs.Entanglement;
import com.quasistellar.rpd.items.armor.glyphs.Flow;
import com.quasistellar.rpd.items.armor.glyphs.Obfuscation;
import com.quasistellar.rpd.items.armor.glyphs.Potential;
import com.quasistellar.rpd.items.armor.glyphs.Repulsion;
import com.quasistellar.rpd.items.armor.glyphs.Stone;
import com.quasistellar.rpd.items.armor.glyphs.Swiftness;
import com.quasistellar.rpd.items.armor.glyphs.Thorns;
