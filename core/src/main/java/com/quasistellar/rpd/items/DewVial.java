...
public class DewVial extends Item {
	...
	public void execute( final Hero hero, String action ) {
		...
		if (action.equals( AC_DRINK )) {
			...
			if (volume > 0) {
				...
				if (Dungeon.hero.heroClass == HeroClass.HUNTRESS) Dungeon.hero.MP = volume;
		...
		if (action.equals(AC_DROP) && hero.heroClass == HeroClass.HUNTRESS) {
			hero.MP = 0;
		}
	}
	...
	public boolean doPickUp(Hero hero) {
		if (hero.heroClass == HeroClass.HUNTRESS) hero.MP = this.volume;
