...
package com.quasistellar.rpd.items.weapon;
...
import com.quasistellar.rpd.items.weapon.curses.Annoying;
import com.quasistellar.rpd.items.weapon.curses.Displacing;
import com.quasistellar.rpd.items.weapon.curses.Exhausting;
import com.quasistellar.rpd.items.weapon.curses.Fragile;
import com.quasistellar.rpd.items.weapon.curses.Friendly;
import com.quasistellar.rpd.items.weapon.curses.Polarized;
import com.quasistellar.rpd.items.weapon.curses.Sacrificial;
import com.quasistellar.rpd.items.weapon.curses.Wayward;
import com.quasistellar.rpd.items.weapon.enchantments.Blazing;
import com.quasistellar.rpd.items.weapon.enchantments.Blocking;
import com.quasistellar.rpd.items.weapon.enchantments.Blooming;
import com.quasistellar.rpd.items.weapon.enchantments.Chilling;
import com.quasistellar.rpd.items.weapon.enchantments.Kinetic;
import com.quasistellar.rpd.items.weapon.enchantments.Corrupting;
import com.quasistellar.rpd.items.weapon.enchantments.Elastic;
import com.quasistellar.rpd.items.weapon.enchantments.Grim;
import com.quasistellar.rpd.items.weapon.enchantments.Lucky;
import com.quasistellar.rpd.items.weapon.enchantments.Projecting;
import com.quasistellar.rpd.items.weapon.enchantments.Shocking;
import com.quasistellar.rpd.items.weapon.enchantments.Unstable;
import com.quasistellar.rpd.items.weapon.enchantments.Vampiric;
