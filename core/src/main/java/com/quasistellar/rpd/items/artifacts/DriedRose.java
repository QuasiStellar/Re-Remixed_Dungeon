...
package com.quasistellar.rpd.items.artifacts;
...
import com.quasistellar.rpd.actors.blobs.CorrosiveGas;
...
import com.quasistellar.rpd.actors.mobs.Wraith;
...
import com.quasistellar.rpd.windows.WndBlacksmith;
...
public class DriedRose extends Artifact {
	...
	public static class GhostHero extends NPC {
		...
		public void sayAppeared(){
			...
			if (RPD.scene() instanceof GameScene) {
				Sample.INSTANCE.play( Assets.SND_GHOST );
			}
		}
					...
					if (rose.weapon != null){
						...
						GameScene.selectItem(new WndBag.Listener() {
							...
							public void onSelect(Item item) {
								...
								} else if (item.unique || ((MeleeWeapon) item).checkSkull() != null) {
