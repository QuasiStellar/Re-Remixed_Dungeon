...
import com.quasistellar.rpd.windows.WndChooseWay;
...
public class TomeOfMastery extends Item {
	...
	public ArrayList<String> actions( Hero hero ) {
		...
		if (hero.heroClass != HeroClass.GNOLL) actions.add( AC_READ );
		return actions;
	}
	...
	public void execute( Hero hero, String action ) {
		...
		if (action.equals( AC_READ )) {
			...
			case NECROMANCER:
				...
				way2 = HeroSubClass.SHADOWMASTER;
				break;
			case GNOLL:
				way1 = HeroSubClass.BRUTE;
