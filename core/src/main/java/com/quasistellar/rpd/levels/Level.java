...
import com.quasistellar.rpd.actors.blobs.SmokeScreen;
import com.quasistellar.rpd.actors.blobs.WellWater;
...
import com.quasistellar.rpd.actors.buffs.LockedFloor;
import com.quasistellar.rpd.actors.buffs.MagicalSight;
import com.quasistellar.rpd.actors.buffs.MindVision;
import com.quasistellar.rpd.actors.buffs.Shadows;
...
import com.quasistellar.rpd.actors.mobs.Bestiary;
import com.quasistellar.rpd.actors.mobs.Mob;
import com.quasistellar.rpd.effects.particles.FlowParticle;
import com.quasistellar.rpd.effects.particles.WindParticle;
...
import com.quasistellar.rpd.items.Torch;
...
import com.quasistellar.rpd.levels.features.HighGrass;
...
public abstract class Level implements Bundlable {
	...
	public int viewDistance = Dungeon.isChallenged( Challenges.DARKNESS ) ? 2 : ((Dungeon.depth == 0) ? 15 : 8);
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		//saves from before oldVersion are not supported
		if (version < RPD.oldVersion){
	...
	public String tileNameByCell( int cell ) {
		return tileName(Dungeon.level.map[cell]);
	}
	...
	public String tileDescByCell( int cell ) {
		return tileDesc(Dungeon.level.map[cell]);
	}
}
