...
package com.quasistellar.rpd.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.quasistellar.rpd.messages.actors.actors",
			"com.quasistellar.rpd.messages.items.items",
			"com.quasistellar.rpd.messages.journal.journal",
			"com.quasistellar.rpd.messages.levels.levels",
			"com.quasistellar.rpd.messages.plants.plants",
			"com.quasistellar.rpd.messages.scenes.scenes",
			"com.quasistellar.rpd.messages.skills.skills",
			"com.quasistellar.rpd.messages.ui.ui",
			"com.quasistellar.rpd.messages.windows.windows",
			"com.quasistellar.rpd.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.quasistellar.rpd.", "");
			key += "." + k;
		} else
			key = k;
