...
import com.quasistellar.rpd.windows.WndJournal;
...
public class StatusPane extends Component {
	...
	protected void createChildren() {
		...
		bg = new NinePatch( Dungeon.hero.heroClass == HeroClass.ELF ? Assets.STATUS_ELF : Assets.STATUS, 0, 0, 128, 36, 85, 0, 45, 0 );
		add( bg );
	...
	public void update() {
		...
		float mana = Dungeon.hero.MP;
		float max_mana = Dungeon.hero.MM;
