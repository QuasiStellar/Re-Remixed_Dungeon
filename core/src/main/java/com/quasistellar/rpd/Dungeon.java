...
import com.quasistellar.rpd.actors.buffs.Light;
...
import com.quasistellar.rpd.actors.mobs.npcs.Blacksmith;
import com.quasistellar.rpd.actors.mobs.npcs.Ghost;
import com.quasistellar.rpd.actors.mobs.npcs.Imp;
import com.quasistellar.rpd.actors.mobs.npcs.PlagueDoctor;
import com.quasistellar.rpd.actors.mobs.npcs.Wandmaker;
...
import com.quasistellar.rpd.levels.CavesBossLevel;
import com.quasistellar.rpd.levels.CavesLevel;
import com.quasistellar.rpd.levels.CityBossLevel;
import com.quasistellar.rpd.levels.CityLevel;
import com.quasistellar.rpd.levels.DeadEndLevel;
import com.quasistellar.rpd.levels.HallsBossLevel;
import com.quasistellar.rpd.levels.HallsLevel;
import com.quasistellar.rpd.levels.IceCavesBossLevel;
import com.quasistellar.rpd.levels.IceCavesLevel;
import com.quasistellar.rpd.levels.LastLevel;
import com.quasistellar.rpd.levels.LastShopLevel;
import com.quasistellar.rpd.levels.Level;
import com.quasistellar.rpd.levels.NecropolisBossLevel;
import com.quasistellar.rpd.levels.NecropolisLevel;
import com.quasistellar.rpd.levels.PrisonBossLevel;
import com.quasistellar.rpd.levels.PrisonLevel;
import com.quasistellar.rpd.levels.SewerBossLevel;
import com.quasistellar.rpd.levels.SewerLevel;
import com.quasistellar.rpd.levels.SpiderNestBossLevel;
import com.quasistellar.rpd.levels.SpiderNestLevel;
import com.quasistellar.rpd.levels.TownLevel;
import com.quasistellar.rpd.levels.VeryLastLevel;
import com.quasistellar.rpd.levels.rooms.secret.SecretRoom;
import com.quasistellar.rpd.levels.rooms.special.SpecialRoom;
import com.quasistellar.rpd.mechanics.ShadowCaster;
...
import com.quasistellar.rpd.utils.DungeonSeed;
...
public class Dungeon {
	...
	public static void switchLevel( final Level level, int pos ) {
		...
		if (depth == 0) {
			Actor reigniter = level.reigniter();
			Actor.add(reigniter);
		}
	...
	private static final String FIRST_AL	= "first_al";
	private static final String SECOND_AL	= "second_al";
	private static final String THIRD_AL	= "third_al";
	...
	public static void saveGame( int save ) throws IOException {
		try {
			...
			bundle.put( FIRST_AL, first_alterlocation );
			bundle.put( SECOND_AL, second_alterlocation );
			bundle.put( THIRD_AL, third_alterlocation );
	...
	public static void loadGame( int save, boolean fullLoad ) throws IOException {
		...
		first_alterlocation = bundle.getBoolean( FIRST_AL );
		second_alterlocation = bundle.getBoolean( SECOND_AL );
		third_alterlocation = bundle.getBoolean( THIRD_AL );
