...
import com.quasistellar.rpd.actors.blobs.Alchemy;
...
import com.quasistellar.rpd.actors.buffs.Barkskin;
import com.quasistellar.rpd.actors.buffs.Berserk;
import com.quasistellar.rpd.actors.buffs.Bless;
import com.quasistellar.rpd.actors.buffs.Buff;
import com.quasistellar.rpd.actors.buffs.Burning;
import com.quasistellar.rpd.actors.buffs.Combo;
import com.quasistellar.rpd.actors.buffs.Drowsy;
import com.quasistellar.rpd.actors.buffs.FlavourBuff;
import com.quasistellar.rpd.actors.buffs.Foresight;
import com.quasistellar.rpd.actors.buffs.Fury;
import com.quasistellar.rpd.actors.buffs.Hunger;
import com.quasistellar.rpd.actors.buffs.Invisibility;
import com.quasistellar.rpd.actors.buffs.ManaRegeneration;
import com.quasistellar.rpd.actors.buffs.MindVision;
import com.quasistellar.rpd.actors.buffs.Momentum;
import com.quasistellar.rpd.actors.buffs.Paralysis;
import com.quasistellar.rpd.actors.buffs.Regeneration;
import com.quasistellar.rpd.actors.buffs.SnipersMark;
...
import com.quasistellar.rpd.effects.CheckedCell;
...
import com.quasistellar.rpd.items.DewVial;
import com.quasistellar.rpd.items.Dewdrop;
import com.quasistellar.rpd.items.Heap;
import com.quasistellar.rpd.items.Heap.Type;
import com.quasistellar.rpd.items.Item;
import com.quasistellar.rpd.items.KindOfWeapon;
import com.quasistellar.rpd.items.armor.glyphs.AntiMagic;
import com.quasistellar.rpd.items.armor.glyphs.Brimstone;
import com.quasistellar.rpd.items.armor.glyphs.Viscosity;
...
import com.quasistellar.rpd.items.keys.CrystalKey;
import com.quasistellar.rpd.items.keys.GoldenKey;
import com.quasistellar.rpd.items.keys.IronKey;
import com.quasistellar.rpd.items.keys.Key;
import com.quasistellar.rpd.items.keys.SkeletonKey;
...
import com.quasistellar.rpd.items.weapon.enchantments.Blocking;
import com.quasistellar.rpd.items.weapon.melee.Flail;
import com.quasistellar.rpd.items.weapon.missiles.MissileWeapon;
import com.quasistellar.rpd.journal.Notes;
import com.quasistellar.rpd.levels.Level;
...
import com.quasistellar.rpd.scenes.AlchemyScene;
import com.quasistellar.rpd.scenes.GameScene;
import com.quasistellar.rpd.scenes.InterlevelScene;
import com.quasistellar.rpd.scenes.SurfaceScene;
...
import com.quasistellar.rpd.windows.WndResurrect;
...
public class Hero extends Char {
	...
	public void updateHT( boolean boostHP ){
		...
		HT = (heroClass == HeroClass.ELF) ? 15 + 4*(lvl-1) + HTBoost : 20 + 5*(lvl-1) + HTBoost;
	...
	private static final String FIRSTSKILL  = "firstskill";
	private static final String SECONDSKILL = "secondskill";
	private static final String THIRDSKILL  = "thirdskill";
	...
	public void storeInBundle( Bundle bundle ) {
		...
		bundle.put( FIRSTSKILL, firstSkill );
		bundle.put( SECONDSKILL, secondSkill );
		bundle.put( THIRDSKILL, thirdSkill );
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		firstSkill = (Skill)bundle.get(FIRSTSKILL);
		secondSkill = (Skill)bundle.get(SECONDSKILL);
		thirdSkill = (Skill)bundle.get(THIRDSKILL);
	...
	public void live() {
		...
		if (heroClass == HeroClass.ROGUE) { Buff.affect( this, ManaRegeneration.class ); }
	}
	...
	private boolean actAlchemy( HeroAction.Alchemy action ) {
		...
		if (Dungeon.level.distance(dst, pos) <= 1) {
			...
			RPD.switchScene(AlchemyScene.class);
			return false;
	...
	public void earnMana( int mana ) {
		...
		if (heroClass == HeroClass.GNOLL) Buff.affect(this, Hunger.class).reduceHunger(mana*18);
		if (heroClass == HeroClass.HUNTRESS && belongings.getItem(DewVial.class) != null) belongings.getItem(DewVial.class).volume += mana;
    }
	...
	public void die( Object cause  ) {
		...
		if (heroClass == HeroClass.NECROMANCER && MP == MM) {
			this.HP = HT;
			...
			Sample.INSTANCE.play( Assets.SND_TELEPORT );
			MP = 0;
			GLog.w( Messages.get(this, "necro_revive") );
