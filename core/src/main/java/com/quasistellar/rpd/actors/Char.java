...
package com.quasistellar.rpd.actors;
...
import com.quasistellar.rpd.actors.buffs.Adrenaline;
import com.quasistellar.rpd.actors.buffs.ArcaneArmor;
...
import com.quasistellar.rpd.actors.buffs.Corruption;
...
import com.quasistellar.rpd.actors.buffs.Haste;
...
import com.quasistellar.rpd.actors.buffs.Preparation;
import com.quasistellar.rpd.actors.buffs.Rage;
import com.quasistellar.rpd.actors.buffs.ShieldBuff;
import com.quasistellar.rpd.actors.buffs.Slow;
import com.quasistellar.rpd.actors.buffs.Speed;
import com.quasistellar.rpd.actors.buffs.Stamina;
...
import com.quasistellar.rpd.items.weapon.missiles.darts.ShockingDart;
import com.quasistellar.rpd.levels.Terrain;
import com.quasistellar.rpd.levels.features.Chasm;
import com.quasistellar.rpd.levels.features.Door;
	...
	public boolean attack( Char enemy ) {
		...
		if (hit( this, enemy, false )) {
			...
			if (enemy == Dungeon.hero) {
				...
				if (enemy.HP == 1) shake = -1;
			}

			if (shake == -1) {
				Badges.validateBrinkOfDeath();
				shake = 2;
				Camera.main.shake( GameMath.gate( 1, shake, 10), 1f );
				shake = -1;
			}
			if (shake > 1f) {
