...
import com.quasistellar.rpd.actors.buffs.Sleep;
import com.quasistellar.rpd.actors.buffs.SoulMark;
...
import com.quasistellar.rpd.effects.Surprise;
import com.quasistellar.rpd.effects.Wound;
...
public abstract class Mob extends Char {
	...
	public void destroy() {
		...
		if (Dungeon.hero.isAlive()) {
			...
			if (alignment == Alignment.ENEMY) {
				...
				if (Dungeon.hero.heroClass == HeroClass.GNOLL) Buff.prolong(Dungeon.hero, Rage.class, 5f);
			}
		}
	}
	...
	public void die( Object cause ) {
		...
		if (cause == Dungeon.hero) {
			if (Dungeon.hero.belongings.weapon != null) {
				if (Dungeon.hero.belongings.weapon instanceof MeleeWeapon &&
						((MeleeWeapon)Dungeon.hero.belongings.weapon).checkSkull() != null) {
					Dungeon.hero.earnMana(1);
				}
			}
		}
		...
		if (Dungeon.hero.buff(Necromancy.class) != null) {
			this.HP = this.HT;
