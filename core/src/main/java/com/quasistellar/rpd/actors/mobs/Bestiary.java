		...
		switch(depth){
			...
			case 2:
				...
				return new ArrayList<>(Arrays.asList(Rat.class, Rat.class, Rat.class,
						GnollScout.class, GnollScout.class, GnollScout.class));
			case 3:
				//2x rat, 4x gnoll, 1x crab, 1x swarm
				return new ArrayList<>(Arrays.asList(Rat.class, Rat.class,
						GnollScout.class, GnollScout.class, GnollScout.class, GnollScout.class,
						Crab.class, Swarm.class));
			case 4: case 5:
				//1x rat, 2x gnoll, 3x crab, 1x swarm
				return new ArrayList<>(Arrays.asList(Rat.class,
						GnollScout.class, GnollScout.class,
