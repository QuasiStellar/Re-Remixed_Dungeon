...
import com.quasistellar.rpd.items.quest.DarkGold;
import com.quasistellar.rpd.items.quest.Pickaxe;
...
import com.quasistellar.rpd.levels.rooms.standard.BlacksmithRoom;
import com.quasistellar.rpd.messages.Messages;
import com.quasistellar.rpd.scenes.GameScene;
import com.quasistellar.rpd.sprites.BlacksmithSprite;
...
public class Blacksmith extends NPC {
	...
	public static void upgrade( Item item1, Item item2 ) {
		...
		if (second instanceof MeleeWeapon){
			MysticalSkull skull = ((MeleeWeapon) second).checkSkull();
			if (skull != null){
				Dungeon.level.drop( skull, Dungeon.hero.pos );
			}
		}
