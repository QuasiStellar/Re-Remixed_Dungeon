...
public class ItemSpriteSheet {
	...
	public static final int BULLET          = UNCOLLECTIBLE+5;
	...
	public static final int RAT_HIDE        = SINGLE_USE+2;
	...
	public static final int ELVEN_DAGGER    = WEP_TIER1+1;
	public static final int GLOVES          = WEP_TIER1+2;
	public static final int STONE_SWORD     = WEP_TIER1+3;
	public static final int DAGGER          = WEP_TIER1+4;
	public static final int MAGES_STAFF     = WEP_TIER1+5;
	static{
		assignItemRect(WORN_SHORTSWORD, 13, 13);
		assignItemRect(ELVEN_DAGGER,    13, 13);
		assignItemRect(GLOVES,          12, 16);
		assignItemRect(STONE_SWORD,     15, 15);
	...
	public static final int ARMOR_ELF        = ARMOR+9;
	public static final int ARMOR_NECROMANCER= ARMOR+10;
	public static final int ARMOR_GNOLL      = ARMOR+11;
	static{
		assignItemRect(ARMOR_CLOTH,      15, 12);
		assignItemRect(ARMOR_LEATHER,    14, 13);
		assignItemRect(ARMOR_MAIL,       14, 12);
		assignItemRect(ARMOR_SCALE,      14, 11);
		assignItemRect(ARMOR_PLATE,      13, 13);
		assignItemRect(ARMOR_WARRIOR,    13, 13);
		assignItemRect(ARMOR_MAGE,       15, 15);
		assignItemRect(ARMOR_ROGUE,      14, 12);
		assignItemRect(ARMOR_HUNTRESS,   13, 15);
		assignItemRect(ARMOR_ELF,        11, 15);
		assignItemRect(ARMOR_NECROMANCER,12, 13);
		assignItemRect(ARMOR_GNOLL,      12, 11);
	}
	...
	public static final int RAT_SKULL= QUEST+0;
