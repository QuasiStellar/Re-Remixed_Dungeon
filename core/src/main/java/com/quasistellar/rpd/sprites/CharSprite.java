...
import com.quasistellar.rpd.effects.DarkBlock;
import com.quasistellar.rpd.effects.EmoIcon;
import com.quasistellar.rpd.effects.FloatingText;
import com.quasistellar.rpd.effects.IceBlock;
import com.quasistellar.rpd.effects.ShieldHalo;
import com.quasistellar.rpd.effects.Speck;
import com.quasistellar.rpd.effects.Splash;
import com.quasistellar.rpd.effects.TorchHalo;
...
public class CharSprite extends MovieClip implements Tweener.Listener, MovieClip.Listener {
	...
	public enum State {
		BURNING, LEVITATING, INVISIBLE, PARALYSED, FROZEN, ILLUMINATED, CHILLED, DARKENED, MARKED, HEALING, SHIELDED, ALLY
	}
	...
	public void add( State state ) {
		switch (state) {
			...
			case ALLY:
				ally = emitter();
				ally.pour(Speck.factory(Speck.HEART), 2f);
				break;
		}
	}
