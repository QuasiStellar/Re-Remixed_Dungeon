...
import com.quasistellar.rpd.ui.CheckBox;
import com.quasistellar.rpd.ui.OptionSlider;
	...
	private class UITab extends Group {
		...
		public UITab(){
			...
			CheckBox chkFont = new CheckBox(Messages.get(this, "system_font")){
				...
				protected void onClick() {
					super.onClick();
					RPD.seamlessResetScene(new Game.SceneChangeCallback() {
						@Override
