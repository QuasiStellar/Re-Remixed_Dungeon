...
public class WndHero extends WndTabbed {
	...
	private class StatsTab extends Group {
		...
		public StatsTab() {
			...
			if (hero.heroClass != HeroClass.ELF) statSlot( Messages.get(this, "mana"), (hero.MP) + "/" + hero.MM );
			statSlot( Messages.get(this, "exp"), hero.exp + "/" + hero.maxExp() );
			statSlot( Messages.get(this, "hunger"), Math.round(hero.buff(Hunger.class).level/10) + "/" + Math.round(Hunger.STARVING/10) );
