...
public class Statistics {
	...
	public static int tombsPlundered;
	public static int strengthUsed;
	...
	private static final String TOMBS		= "tombsPlundered";
	private static final String STRENGTH	= "strengthUsed";
	...
	public static void storeInBundle( Bundle bundle ) {
		...
		bundle.put( TOMBS,		tombsPlundered );
		bundle.put( STRENGTH,	strengthUsed );
	...
	public static void restoreFromBundle( Bundle bundle ) {
		...
		tombsPlundered	= bundle.getInt( TOMBS );
		strengthUsed    = bundle.getInt( STRENGTH );
